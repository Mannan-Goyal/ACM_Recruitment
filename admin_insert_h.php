...
<html>
  <head>
    ...
    <title>ACM Recruitment - Dashboard</title>
  ...
  <section class="section">
    <div class="container">
      <h1 class="title is-1">Insert a New User Here:</h1>
    <form action="backend/admin_insert.php" method="post">
<div class="field">
...
<div class="field">
  ...
  <div class="control has-icons-left has-icons-right">
    <input class="input" type="number" placeholder="Enter Balance" name="balance">
    <span class="icon is-small is-left">
...
<div class="field is-grouped">
  <div class="control">
    <input class="button is-link" value="Insert" type="submit">
  </div>
</div>
</form>
    </div>
